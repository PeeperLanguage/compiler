...
> Current implementation snapshot: [`docs/compiler-architecture.md`](docs/compiler-architecture.md).
> The old branch/workflow,
...
> Go baseline is declared in [`go.mod`](go.mod). This history authorizes no branch changes, commits, or shipping.
